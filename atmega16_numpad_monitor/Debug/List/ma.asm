...
; 0000 003B             number[i]=check();
	...
	ST   X+,R30
	ST   X,R31
; 0000 003C             if(number[i]==11){for(j=0;j<10;j+=1){number[j]=11;i=-1;}}
	MOVW R30,R10
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x2
	CPI  R30,LOW(0xB)
...
_show:
; .FSTART _show
; 0000 0047         position=0x00;
	CLR  R5
; 0000 0048 
; 0000 0049         delay_ms(10);
	RCALL SUBOPT_0x0
; 0000 004A 
; 0000 004B         for(sh_i=0;sh_i<10;sh_i+=1)
	CLR  R6
	CLR  R7
_0x13:
	LDI  R30,LOW(10)
...
; 0000 004C         {
; 0000 004D 
; 0000 004E             PORTA=position;
	OUT  0x1B,R5
; 0000 004F 
; 0000 0050             PORTB=ssd[number[sh_i]];
	MOVW R30,R6
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x2
	SUBI R30,LOW(-_ssd)
...
_0x15:
	...
	RJMP _0x17
; 0000 005D         {
; 0000 005E             for(bt_i=0;bt_i<3;bt_i+=1)
	CLR  R8
	CLR  R9
_0x19:
	LDI  R30,LOW(3)
	...
	BRGE _0x1A
; 0000 005F             {
; 0000 0060                   PORTC=cpositions[bt_i];
	...
	LD   R30,X
	OUT  0x15,R30
; 0000 0061                   if(r1==1){ch=0;return rcposition[0][bt_i];}
	SBIS 0x13,3
	RJMP _0x1B
	CLT
	BLD  R2,0
	...
	RJMP _0x2000002
; 0000 0062                    if(r2==1){ch=0;return rcposition[1][bt_i];}
_0x1B:
	SBIS 0x13,4
	RJMP _0x1C
	CLT
	...
	RJMP _0x2000001
; 0000 0063                     if(r3==1){ch=0;return rcposition[2][bt_i];}
_0x1C:
	SBIS 0x13,5
	RJMP _0x1D
	CLT
	...
	RJMP _0x2000001
; 0000 0064                      if(r4==1){ch=0;return rcposition[3][bt_i];}
_0x1D:
	SBIS 0x13,6
	RJMP _0x1E
	CLT
